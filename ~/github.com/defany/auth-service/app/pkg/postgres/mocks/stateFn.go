...
func (_m *MockstateFn) Execute(_a0 *pgx.sqlLexer) pgx.stateFn {
	ret := _m.Called(_a0)
	...
	var r0 pgx.stateFn
	if rf, ok := ret.Get(0).(func(*pgx.sqlLexer) pgx.stateFn); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(pgx.stateFn)
		}
	}
...
func (_c *MockstateFn_Execute_Call) Run(run func(_a0 *pgx.sqlLexer)) *MockstateFn_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*pgx.sqlLexer))
	})
	return _c
}

func (_c *MockstateFn_Execute_Call) Return(_a0 pgx.stateFn) *MockstateFn_Execute_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockstateFn_Execute_Call) RunAndReturn(run func(*pgx.sqlLexer) pgx.stateFn) *MockstateFn_Execute_Call {
	_c.Call.Return(run)
	return _c
}
