...
func (x *GetUserResponse) GetPasswordConfirm() string {
	if x != nil {
		return x.PasswordConfirm
	}
	return ""
...
var file_auth_v1_auth_proto_rawDesc = []byte{
	...
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f,
	0x65, 0x6d, 0x70, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xab, 0x01, 0x0a, 0x11,
	...
	0x72, 0x6d, 0x12, 0x25, 0x0a, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e,
	...
	0x64, 0x22, 0xaf, 0x02, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73,
	...
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x11, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x2e, 0x55,
	...
	0x64, 0x41, 0x74, 0x22, 0xbe, 0x01, 0x0a, 0x11, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73,
	...
	0x2a, 0x0a, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x11, 0x2e,
	0x61, 0x75, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x6f, 0x6c, 0x65,
	...
	0x41, 0x44, 0x4d, 0x49, 0x4e, 0x10, 0x02, 0x32, 0x8f, 0x02, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68,
	...
	0x73, 0x65, 0x72, 0x12, 0x1a, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x70,
	...
	0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x42, 0x86, 0x01, 0x0a, 0x0b, 0x63, 0x6f,
...
var file_auth_v1_auth_proto_goTypes = []interface{}{
	...
	(*UpdateUserRequest)(nil),      // 5: auth.v1.UpdateUserRequest
...
var file_auth_v1_auth_proto_depIdxs = []int32{
	0,  // 0: auth.v1.CreateUserRequest.role:type_name -> auth.v1.UserRole
	0,  // 1: auth.v1.GetUserResponse.role:type_name -> auth.v1.UserRole
	7,  // 2: auth.v1.GetUserResponse.created_at:type_name -> google.protobuf.Timestamp
	7,  // 3: auth.v1.GetUserResponse.updated_at:type_name -> google.protobuf.Timestamp
	8,  // 4: auth.v1.UpdateUserRequest.name:type_name -> google.protobuf.StringValue
	8,  // 5: auth.v1.UpdateUserRequest.email:type_name -> google.protobuf.StringValue
	0,  // 6: auth.v1.UpdateUserRequest.role:type_name -> auth.v1.UserRole
	1,  // 7: auth.v1.Auth.CreateUser:input_type -> auth.v1.CreateUserRequest
	3,  // 8: auth.v1.Auth.GetUser:input_type -> auth.v1.GetUserRequest
	5,  // 9: auth.v1.Auth.UpdateUser:input_type -> auth.v1.UpdateUserRequest
	6,  // 10: auth.v1.Auth.DeleteUser:input_type -> auth.v1.DeleteUserRequest
	2,  // 11: auth.v1.Auth.CreateUser:output_type -> auth.v1.CreateUserResponse
	4,  // 12: auth.v1.Auth.GetUser:output_type -> auth.v1.GetUserResponse
	9,  // 13: auth.v1.Auth.UpdateUser:output_type -> google.protobuf.Empty
	9,  // 14: auth.v1.Auth.DeleteUser:output_type -> google.protobuf.Empty
