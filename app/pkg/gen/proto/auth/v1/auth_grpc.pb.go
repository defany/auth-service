...
const (
	...
	AuthService_GetRefreshToken_FullMethodName = "/auth.v1.AuthService/GetRefreshToken"
	AuthService_GetAccessToken_FullMethodName  = "/auth.v1.AuthService/GetAccessToken"
)
...
func (c *authServiceClient) GetRefreshToken(ctx context.Context, in *GetRefreshTokenRequest, opts ...grpc.CallOption) (*GetRefreshTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_GetRefreshToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
